 ...
 * @author Jordan
 */
public class DisplayRegistrationRecordByAdmissionStatus implements ItemListener{
    ...
    public DisplayRegistrationRecordByAdmissionStatus(JTable jtblRegistrationRecord, JComboBox jcmbAdmissionStatus) {
