 ...
 * @author Jordan
 */
public class DisplayRegistrationRecordByWildCard implements ActionListener{
    ...
    public DisplayRegistrationRecordByWildCard(JTextField jtfSearchRegistered, JTable jtblRegisteredMasterList) {
