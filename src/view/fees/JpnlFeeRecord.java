 ...
 * 
 */
public class JpnlFeeRecord extends javax.swing.JPanel implements Initializer {

    private FeeJCompModelLoader feeJCompModelLoader;
    private DefaultTableModel dtmFeeRecord;
    
    public JpnlFeeRecord() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jtblFeeRecord.setMinimumSize(new java.awt.Dimension(1185, 265));
        jtblFeeRecord.setPreferredSize(new java.awt.Dimension(1185, 265));
        ...
        jtblFeeGradeLevelAssignment.setMinimumSize(new java.awt.Dimension(1185, 230));
        jtblFeeGradeLevelAssignment.setPreferredSize(new java.awt.Dimension(1185, 230));
