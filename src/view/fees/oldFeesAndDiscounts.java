...
import component_model_loader.DiscountJCompModelLoader;
...
public class oldFeesAndDiscounts extends javax.swing.JPanel {

    DiscountDaoImpl ddi = new DiscountDaoImpl();
    SchoolYearDaoImpl sdi = new SchoolYearDaoImpl();
    FeeDaoImpl fdi = new FeeDaoImpl();
    FeeJCompModelLoader feeML = new FeeJCompModelLoader();
    DiscountJCompModelLoader discountGUIUtil = new DiscountJCompModelLoader();
    GradeLevelDaoImpl gldi = new GradeLevelDaoImpl();
    private final DecimalFormat decimalFormatter = new DecimalFormat("#,#00.00");
//    private CreateFeeController createFeeController;

    public oldFeesAndDiscounts() {
        initComponents();
//
//        createFeeController = new CreateFeeController(
//                jtfFeeName, jtaFeeDescription, jcmbFeeCategory,
//                jtfKindergartenAmount,
//                jtfGrade1Amount, jtfGrade2Amount, jtfGrade3Amount,
//                jtfGrade4Amount, jtfGrade5Amount, jtfGrade6Amount,
//                jtfGrade7Amount, jtfGrade8Amount, jtfGrade9Amount,
//                jtfGrade10Amount, jpnlGradeLevels, jlstFeeNameList);
//        jbtnCreateFee.addActionListener(createFeeController);
    ...
    private void initComponents() {
        ...
        jpnlGradeLevels.setBorder(javax.swing.BorderFactory.createTitledBorder("Grade Levels"));
        ...
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jtfKindergartenAmount, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jtfGrade1Amount, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jtfGrade2Amount, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jtfGrade3Amount, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jtfGrade4Amount, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jtfGrade5Amount, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jtfGrade6Amount, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jtfGrade7Amount, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jtfGrade8Amount, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jtfGrade9Amount, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jtfGrade10Amount, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jcbGrade1, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jcbGrade2, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jcbGrade3, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jcbGrade4, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jcbGrade5, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 1;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jcbGrade6, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 2;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jcbGrade7, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 3;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jcbGrade8, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 4;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jcbGrade9, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 5;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jpnlGradeLevels.add(jcbGrade10, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 0.5;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jPanel15.add(jButton1, gridBagConstraints);
        ...
        jcmbFeeCategory.setModel(new component_model_loader.FeeJCompModelLoader().getAllFeeCategoriesAsModel());
        ...
        jlstFeeNameList.setModel(new component_model_loader.FeeJCompModelLoader().getAllFeeNamesAsModel());
    ...
    private void resetCreateFeeFormPanel() {
        JPanelUtil.uncheckCheckBoxes(jpnlFeeAmount);
        JPanelUtil.clearJTextFields(jpnlFeeAmount);
        jtfFeeName.setText("");
...
//        }
    ...
    private void jlstFeeNameListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_jlstFeeNameListValueChanged
        ...
        int aFeeId = fdi.getFeeId(feeName);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String amountToApplyToAll = jtfApplyToAllAmount.getText().trim();
        if (!amountToApplyToAll.equals("")) {
            ...
            for (Component c : components) {
                ...
                if (c instanceof JTextField) {
                    ((JTextField) c).setText(decimalFormatter.format(amount));
                }
            }
        }
