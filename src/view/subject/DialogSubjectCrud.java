...
public class DialogSubjectCrud extends javax.swing.JDialog implements Initializer{
    ...
    private void initComponents() {
        ...
        jbtnCancel.setPreferredSize(new java.awt.Dimension(71, 31));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        jbtnClear.setPreferredSize(new java.awt.Dimension(71, 31));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        ...
        jbtnSave.setPreferredSize(new java.awt.Dimension(71, 31));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
