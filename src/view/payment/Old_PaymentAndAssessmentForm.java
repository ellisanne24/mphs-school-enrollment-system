 ...
 * @author Jordan
 */
public class Old_PaymentAndAssessmentForm extends javax.swing.JPanel {

    GUIManager guiManager = new GUIManager();
    private final DiscountJCompModelLoader discountML = new DiscountJCompModelLoader();
//    private DisplayPaymentFormController displayPaymentFormController;
    
    private final Image studentPhoto;
    
    public Old_PaymentAndAssessmentForm() {
        initComponents();
...
//        jtblBalanceBreakdown.addMouseListener(new EnablePaySelectedButton(jtblBalanceBreakdown, jbtnPaySelected));
    ...
    jcmbSchoolYearFrom.setModel(new component_model_loader.SchoolYearJCompModelLoader().getAllSchoolYearStart());
    ...
    jcmbSchoolYearTo.setModel(new component_model_loader.SchoolYearJCompModelLoader().getAllSchoolYearEnd());
    ...
    jcmbTransactionSyYearFrom.setModel(new component_model_loader.SchoolYearJCompModelLoader().getAllSchoolYearStart());
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
    ...
    class GUIManager {
        private void initializeModels(){
            PaymentTermJCompModelLoader paymentTermML = new PaymentTermJCompModelLoader();
