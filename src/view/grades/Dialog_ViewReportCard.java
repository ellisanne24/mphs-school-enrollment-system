...
public class Dialog_ViewReportCard extends javax.swing.JDialog implements Initializer {
    ...
    public Dialog_ViewReportCard(java.awt.Frame parent, boolean modal, Student student) {
        super(parent, modal);
        initComponents();
