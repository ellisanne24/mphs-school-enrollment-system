...
public class Dialog_OverrideGrading extends javax.swing.JDialog implements Initializer{

    private final User user;

    public Dialog_OverrideGrading(java.awt.Frame parent, boolean modal, User user) {
        super(parent, modal);
        initComponents();
        this.user = user;
