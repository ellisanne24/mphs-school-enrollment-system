 ...
 * @author Paul
 */
public class PrintGradesDialog extends javax.swing.JDialog {

    /**
     * Creates new form UpdateGrades
     */
    public PrintGradesDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(80, 590));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrintGradesDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PrintGradesDialog dialog = new PrintGradesDialog(new javax.swing.JFrame(), true);
