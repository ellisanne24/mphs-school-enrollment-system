 ...
 */
public class dialog_winthdrawenrollment extends javax.swing.JDialog {

    /**
     * Creates new form dialog_winthdrawenrollment
     */
    public dialog_winthdrawenrollment(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialog_winthdrawenrollment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialog_winthdrawenrollment dialog = new dialog_winthdrawenrollment(new javax.swing.JFrame(), true);
